...
<Card
  ...
  href="/langsmith/server-mcp"
  icon="plug"
>
Expose and consume tools via MCP, and connect agents using the A2A protocol.
</Card>
...
>
Visualize graphs, inspect checkpoints, step through runs, and debug agents interactively.
</Card>

<Card
  title="Server customization"
  cta="Customize your server"
  href="/langsmith/custom-routes"
  icon="tool"
>
Add custom routes, middleware, lifespan hooks, encryption, and authentication.
</Card>
