...
If you are running a Helm chart version older than 0.13.20, or need more control over the export process, you can use the SQL-based export scripts below.
